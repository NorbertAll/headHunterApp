...
const PanelStudent: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3001/studenprofil/${id}`)
      .then((response) => {
  ...
  const onSubmit = (data: any) => {
    axios
      .post(`http://localhost:3001/studenprofil/${id}`, data)
      .then((response) => {
        console.log(response);
      });
  };
      ...
      >
        <Form className="formContainer" style={styles.formstudent}>
          ...
          <Field
            ...
            id="project_urls"
            name="project_urls"
            placeholder="Tablica URL-i do GitHuba  projektu zaliczeniowego"
          />
          <br />
          <br />
          <p>
          ...
          <Field
            ...
            placeholder="Docelowe miasto, gdzie   chce pracować kandydat."
          />
          <br />
          <br />
          <p>
          ...
          <br />
          <p>
            <b>Ilość miesięcy doświadczenia komercyjnego kandydata w programowaniu.</b>
          </p>
          <Field
            style={styles.formFiels}

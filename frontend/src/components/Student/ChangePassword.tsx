...
const validationSchema = Yup.object().shape({
  ...
  return (
    ...
    <Form className="formContainer" style={styles.formpassword}>
        ...
        <Field style={styles.formFiels} id="password" type="password" name="password" placeholder="Password"/>
        <br /><br />
        <p><b>Potwierdź nowe hasło</b></p>
        <div style={styles.errors}>
          <ErrorMessage name="password_confirm" component="span" />
        </div>
        <Field style={styles.formFiels} id="password_confirm" type="password" name="password_confirm" placeholder="Confirm Password"/>
        <br /><br />
